...
|---------|---------|---------|
|**Customer Focus and Health**:<br>Demonstrates ability to establish, grow and drive strategic relationships with the customer’s IT infra, Security and Business stakeholders and across internal MS teams. Maps business scenarios to technology solutions. Manages and removes business or technical deployment challenges. Leads with an identity driven security approach based on Microsoft best practices.  |Cultivate customer relationships and credibility through strong technical delivery to understand business goals and strategic solution requirements (Trusted Advisor). Articulates the competitive advantages of Microsoft’s solution or service. Demonstrates a sound understanding of current technology products and services. Stays engaged, responsive, and communicates on a regular cadence. Presents options and workarounds to move engagements forward and, where necessary, escalates appropriately to remove blockers. Delivers solutions that meet the customer’s business needs.         |**Quantitative**: CPE/NPS scores, feedback and resultant follow up/actions.<br>**Quantitative**: Internal stakeholder engagement feedback.<br>**Quantitative**: Lead/manager feedback call shadow.<br>**Qualitative**: Portfolio AE/QE increase.<br> **Qualitative**: Insights / Product Feedback.          |
|**Technical Leadership**:<br>Be a Technical Leader for your Practice by providing thought leadership, articulation of solutions value and outcomes for business strategies through collaboration, credibility and courage.   |Evangelize the value of FastTrack Benefit Services. Ensure customer’s expectations are managed while acting as a trusted advisor through collaboration with key stakeholders. Is engaged in relevant technical communities and consistently contributes in discussions and calls, fostering a community that generates feedback helping others learn. Identify opportunities to influence the customer’s ratio of cloud services versus on premises services.         |**Quantitative**: Peer feedback (Kudos, Perspectives, etc).<br>**Qualitative**: Record status notes and workload status in FTOP documented within guidelines published in FastTrack playbook.<br>**Qualitative**: Submit Insights & Spotlights.<br>**Qualitative**: Adhere to all security and privacy policies.        |
|**Operational Excellence**:<br>Systematic capture and maintain data elements that support the management of our business and drive improvement of our products.    |Schedules and adheres to customer cadence for active workloads. Leveraging subject matter experts directly aligned to customer needs. Regular touchpoints with the FMs. Account Teams & FTAs. Coordination with Support/Partners/MCS. Effective escalations to remove blockers. Maintain compliance with all security and privacy policies.         |**Quantitative**: Portfolio health reviews with lead/manager.<br>**Quantitative**: Consistent account team engagement.<br>**Quantitative**: Feedback from peers and leadership.<br>**Quantitative**: Immediately report identified security/privacy violations.         |

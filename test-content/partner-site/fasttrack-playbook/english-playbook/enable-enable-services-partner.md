...
Primary Role: **FastTrack Engineer**  
Motions: **Customer Health / RFA / Targeting**  
Applies To: **Microsoft 365 Apps / Windows 10**

Complete the tasks to perform Get Modern enablement.  **\*For Windows and Microsoft 365 Apps, the goal is to achieve 70%+ MAD/MAU.**  

- **Microsoft 365 Apps:**  For the remainder of FY20, **Microsoft 365 Apps is the #1 priority.**  Please ensure every customer you work with is deploying Microsoft 365 Apps, as it should be deployed concurrently with any workload.  
  - See ProPlus workload playbook task 1247 Deploy Microsoft 365 Apps in FTOP.  
- **Windows 10:**  For the remainder of FY20, Microsoft 365 Apps is the #1 priority.  Any high-deploy Win10 should have Microsoft 365 Apps attached.  
...
- Technical Enablement notes capture the following (if applicable):
    ...
    - Microsoft 365 Apps Deployment Package build is complete and distribution method chosen (local or cloud)
    - Microsoft 365 Apps deployment wizard shared with customer
    - PowerShell parameter script copied to SCCM servers(s) and pilot devices tested against the OTR results 
    - PowerShell Microsoft 365 Apps deployment package's execution status for the general use devices (outside pilot lab)
- Engagement Management notes capture the following (if applicable): 
    ...
    - Lynx used to confirm customer's Microsoft 365 Apps usage is tracked to > 70% for two months post-deployment
        - Consumption Status (L1) = In Progress
        - Reason (L2) = Solution or User Adoption
...
| 1247    | Deploy Microsoft 365 Apps                                                                                |            M             |     FastTrack Engineer     | Microsoft 365 Apps                                                     |
| 4033    | Microsoft 365 Apps Phased Deployment with System Center                                                  |            O             |            SME             | Microsoft 365 Apps                                                         |
| 3650    | Microsoft 365 Apps - Microsoft 365 Apps Acceleration |            O             | FastTrack Manager | Microsoft 365 Apps |
| 4111    | Managing Existing Microsoft 365 Apps in the Remote Work Scenario                                 |            O             |     SME     | Microsoft 365 Apps / Windows 10                                 |

### Deploy Mobile Apps 

Primary Role: **FastTrack Engineer**  
Motions: **Customer Health / RFA / Targeting**  
Applies To: **Intune / Microsoft 365 Apps / Windows 10**
...
| Task ID | Task Name                                     | (M)andatory / (O)ptional | FastTrack Role | Services |
| ------- | --------------------------------------------- | :----------------------: | :------------: | -------- |
| 4110    | Deploy Mobile Office Apps                                                              |            O            |     FastTrack Engineer     |      Intune / Microsoft 365 Apps / Windows 10        |
...
| ---------- | ----------------- | ----------------      |
| 5/12/2020  | James Collins | Added step Deploy Mobile Apps|
| 3/25/2020  | Celia Kennedy | General Maintenance |
